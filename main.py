...
from discord_notifier import load_instance_discord_settings
    ...
    class Main:
        ...
        def __init__(self):
            ...
            self.discord_control = DiscordControlServer(
                ...
                settings_loader=load_instance_discord_settings,
...
def run_app(instance_name=None):
    ...
    def HubMenuWithName(*args, **kwargs):
        kwargs.setdefault("instance_name", instance_name)
        return HubMenu(*args, **kwargs)

    app = App(login, SelectBrawler, pyla_main, all_brawlers, HubMenuWithName)
